...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:box nil :inverse-video nil :foreground "#807256" :background "#302317"))))
 '(mode-line-highlight ((((class color) (min-colors 88)) (:box (:line-width 2 :color "grey40" :style released-button))) (t (:inherit (highlight)))))
 '(mode-line-inactive ((t (:box nil :inverse-video nil :background "#303030" :inherit mode-line))))
 ...
 '(sml/global ((t :foreground "#807256" :inverse-video nil)))
 '(sml/modes ((t :inherit sml/global :foreground "White")))
 '(sml/filename ((t :inherit sml/global :foreground "#decdac" :weight bold)))
 '(sml/prefix ((t :inherit sml/global :foreground "#e8934b")))
